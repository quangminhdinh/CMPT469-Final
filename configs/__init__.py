...
class OptimizationParams(ParamGroup):
    ...
    def __init__(self, parser):
        ...
        self.deform_lr_init = 2e-2
        self.deform_lr_final = 5e-4
        self.density_lr_init = 1e-1
        self.density_lr_final = 1e-2
        self.attributes_lr_init = 5e-3
        self.attributes_lr_final = 5e-4
        self.temporal_center_lr_init = 3e-2
        self.temporal_center_lr_final = 3e-3
        self.temporal_duration_lr_init = 5e-4
        self.temporal_duration_lr_final = 5e-5
        self.temporal_attr_scale_lr_init = 5e-4
        self.temporal_attr_scale_lr_final = 5e-5
        self.sh_factor = 0.1
