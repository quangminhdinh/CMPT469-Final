...
class DynamicFoamScene(torch.nn.Module):
    ...
    def get_temporal_attr(self, attr, t):
        t_var = t - self.t_center
        t_dist = t_var / torch.exp(self.t_duration)
